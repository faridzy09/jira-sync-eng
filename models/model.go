...
type JiraIssue struct {
	...
	HangingBugHours           *float64   `json:"hanging_bug_hours" db:"hanging_bug_hours"`
	HangingBugDayWorkHours    *float64   `json:"hanging_bug_day_work_hours" db:"hanging_bug_day_work_hours"`
